...
protected:
    const float hover_throttle = 1.8; // increace to reduce max power of motor (was 0.7)
    ...
    struct {
        ...
        float c_drag_p = 0.04; //coeff of drag as a function of airspeed (paracitic drag) (was 0.1)
        float c_y_0 = 0;
        float c_y_b = -0.98;
        float c_y_p = 0;
        float c_y_r = 0;
